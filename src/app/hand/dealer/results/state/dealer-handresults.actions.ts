...
export enum dealerhandresultsActionTypes {
...
export class SetHandId implements Action {
  readonly type = dealerhandresultsActionTypes.SET_HAND_ID;
  constructor(public payload: number) { }
}

export class ClearHandId implements Action {
  readonly type = dealerhandresultsActionTypes.CLEAR_HAND_ID;

}

export class HandIdFail implements Action {
  readonly type = dealerhandresultsActionTypes.HAND_ID_FAIL;
  constructor(public payload: string) {}
}

// USERID
export class SetUserId implements Action {
  readonly type = dealerhandresultsActionTypes.SET_USER_ID;
  constructor(public payload: number){}
}


export class ClearUserId implements Action {
  readonly type = dealerhandresultsActionTypes.CLEAR_USER_ID;

}
export class UserIdFail implements Action {
  readonly type = dealerhandresultsActionTypes.USER_ID_FAIL;
  constructor(public payload: string){}
}

// PLAYER LIMIT
export class SetPlayerLimit implements Action {
  readonly type = dealerhandresultsActionTypes.SET_PLAYER_LIMIT;
  constructor(public payload: number){ }
}

export class ClearPlayerLimit implements Action {
  readonly type = dealerhandresultsActionTypes.CLEAR_PLAYER_LIMIT;

}

export class PlayerLimitFail implements Action {
  readonly type = dealerhandresultsActionTypes.PLAYER_LIMIT_FAIL;
  constructor(public payload: string ) {}
}

// HIGH VALUE
export class SetHighValue implements Action {
  readonly type = dealerhandresultsActionTypes.SET_H_VALUE;
  constructor (public payload: number){}
}

export class ClearHighValue implements Action {
  readonly type = dealerhandresultsActionTypes.CLEAR_H_VALUE;

}

export class HighValueFail implements Action {
  readonly type = dealerhandresultsActionTypes.H_VALUE_FAIL;
  constructor(public payload: string ){}
}

//  LOW VALUE
export class SetLowValue implements Action {
  readonly type = dealerhandresultsActionTypes.SET_L_VALUE;
  constructor(public payload: number){}
}

export class ClearLowValue implements Action {
  readonly type = dealerhandresultsActionTypes.CLEAR_L_VALUE;

}

export class LowValueFail implements Action {
  readonly type = dealerhandresultsActionTypes.L_VALUE_FAIL;
  constructor(public payload: string){}
}


export type DealerHandResultsActions = SetHandId
  | ClearHandId
  | HandIdFail
  | SetPlayerLimit
  | ClearPlayerLimit
