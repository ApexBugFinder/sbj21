...
export enum dealerhandstatusActionTypes {
...
export class SetHandId implements Action {
  readonly type = dealerhandstatusActionTypes.SET_HAND_ID;
  constructor(public payload: number) { }
}


export class ClearHandId implements Action {
  readonly type = dealerhandstatusActionTypes.CLEAR_HAND_ID;

}

export class SetHandIdError implements Action {
  readonly type = dealerhandstatusActionTypes.SET_HAND_ID_FAIL;
  constructor(public payload: string) {}
}

export class SetHandStatus implements Action {
  readonly type = dealerhandstatusActionTypes.SET_HAND_STATUS;
  constructor( public payload: string) {}
}

export class ClearHandStatus implements Action {
  readonly type = dealerhandstatusActionTypes.CLEAR_HAND_STATUS;
}

export class SetHandStatusError implements Action {
  readonly type = dealerhandstatusActionTypes.SET_HAND_STATUS_FAIL;
  constructor(public payload: string ) {}
}

export class SetHandStatusUsername implements Action {
  readonly type = dealerhandstatusActionTypes.SET_USERNAME;
  constructor(public payload: string) {  }
}

export class ClearHandStatusUsername implements Action {
  readonly type = dealerhandstatusActionTypes.CLEAR_USERNAME;

}
export class SetHandStatusUsernameError implements Action {
  readonly type = dealerhandstatusActionTypes.SET_HAND_STATUS_USERNAME_FAIL;
  constructor(public payload: string) {}
}

export type DealerHandStatusActions = SetHandId
  | ClearHandId
  | SetHandIdError
  | SetHandStatus
  | ClearHandStatus
