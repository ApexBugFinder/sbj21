...
export enum playerActionTypes {
  ...
  SET_PLAYERSHELL_PLAYER= '[Player] Set PlayerShell Player'
}
...
export class SetPlayerShellPlayer implements Action {
  readonly type = playerActionTypes.SET_PLAYERSHELL_PLAYER;
  constructor(public payload: Player) {}
}
export type PlayerShellActions =
  | LoadPlayer
  | LoadPlayerSuccess
  | LoadPlayerFail
  | ClearPlayer
